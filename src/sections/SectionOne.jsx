...
const SectionOne = () => {
  return (
    <>
      <div className="heroSection   text-white 2xl:flex 2xl:flex-col 2xl:items-center 2xl:gap-[4rem]  px-[2rem] md:px-[4rem] lg:px-[6rem] xl:px-[9rem] 2xl:[px-12rem] py-[4rem] xl:py-[6rem]">
        <h1 className="text-5xl md:text-8xl xl:text-9xl leading-[1.1] xl:leading-[1.2] font-medium">
