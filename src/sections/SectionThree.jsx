...
const SectionThree = () => {
  return (
    <> 
         <div className="sectionThree    text-white lg:flex md:items-center 2xl:justify-center  px-[2rem] md:px-[4rem] lg:px-[6rem] xl:px-[9rem] 2xl:px-[12rem] py-[1rem] md:py-[3rem]">
        ...
        <div className="boxTwo lg:w-1/2 2xl:w-[35%]  ">
          <img src={LearningSVG} className="w-full h-full" alt="" />
        </div>
      </div>
    </>
  )
